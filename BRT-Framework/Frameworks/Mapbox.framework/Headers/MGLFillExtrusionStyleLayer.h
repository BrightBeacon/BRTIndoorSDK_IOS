 ...
 * Interpolation and step functions applied to the `$zoomLevel` variable and/or
 feature attributes
 */
@property (nonatomic, null_resettable) NSExpression *fillExtrusionOutlineColor;
#else
/**
 The base color of the extruded fill. The extrusion's surfaces will be shaded
 differently based on this color in combination with the root `light` settings.
...
/**
 The transition affecting any changes to this layer’s `fillExtrusionOutlineColor` property.

 This property corresponds to the `fill-extrusion-outline-color-transition` property in the style JSON file format.
*/
@property (nonatomic) MGLTransition fillExtrusionOutlineColorTransition;
 ...
 * Interpolation and step functions applied to the `$zoomLevel` variable and/or
 feature attributes
 */
@property (nonatomic, null_resettable) NSExpression *fillExtrusionOutlineWidth;

/**
 The transition affecting any changes to this layer’s `fillExtrusionOutlineWidth` property.

 This property corresponds to the `fill-extrusion-outline-width-transition` property in the style JSON file format.
*/
@property (nonatomic) MGLTransition fillExtrusionOutlineWidthTransition;
