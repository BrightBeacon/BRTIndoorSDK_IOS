 ...
 *   @param cids    禁行设施类别ID
 */
- (void)requestRouteWithStart:(BRTLocalPoint *)start end:(BRTLocalPoint *)end stops:(NSArray<BRTLocalPoint *> *)stops sortStop:(BOOL)sort vehicle:(int)vehicle ignore:(NSArray<NSString *> *)cids;
